...
.then((response) => {
  ...
  return (
    ...
    <View style={styles.body}>
        <ImageBackground source={SPRING} style={styles.backgroundImage}>
          ...
          <View style={styles.mainConatinerStyle}>
            <Button color="#d3a3a1" title="Scan for Poison Ivy"   onPress={() =>
        this.props.navigation.navigate('Capture!')
      }></Button>
            </View>  
          <View style={styles.snakesButton}>
            <Button color="#d3a3a1" title="Scan Snakes" onPress={() =>
        this.props.navigation.navigate('Capture!')
      }></Button>
          </View>
        </ImageBackground>
