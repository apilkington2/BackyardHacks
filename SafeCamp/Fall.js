...
export const FALL = require('./fall.png');
...
.then((response) => {
  ...
  return (
    ...
    <View style={styles.body}>
        <ImageBackground source={FALL} style={styles.backgroundImage}>
          ...
          <View style={styles.mainConatinerStyle}>
            <Button color="#7b312b" title="Scan for Poison Ivy"   onPress={() =>
        this.props.navigation.navigate('Capture!')
      }></Button>
            </View>  
          <View style={styles.snakesButton}>
            <Button color="#7b312b" title="Scan Snakes" onPress={() =>
        this.props.navigation.navigate('Capture!')
      }></Button>
          </View>
        </ImageBackground>
